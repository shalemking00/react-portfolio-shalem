...
import profilePic from '../assets/shalemProfile.jpg'
      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            initial="hidden"
            animate="visible"
            className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Shalem Raju</motion.h1>
        ...
        <div className='flex justify-center rounded'>
            ...
            transition={{duration:1,delay:1.2}}
             src={profilePic} width={500} height={500} className='rounded' alt="shalem King" />
        </div>
